...
{
    public class UIImageNeo : UIElement
    {
        ...
        public UIImageNeo(Asset<Texture2D> texture)
        {
            SetImage(texture);
        }

        public UIImageNeo(Texture2D nonReloadingTexture)
        {
        ...
        protected override void DrawSelf(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(texture2D, vector2, Rectangle, Color, Rotation, vector * NormalizedOrigin, ImageScale, SpriteEffects.None, 0f);
        }
    }
}
